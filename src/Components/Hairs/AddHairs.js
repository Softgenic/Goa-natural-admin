...
const AddHairs = () => {
  ...
  const submitform = (e) => {
    e.preventDefault();
    console.log("submiting form", image);
    axios
      .post(
        "https://golden.softgenics.in/api/addProduct",
        {
          p_name: p_name,
          price: price,
          image: image,
  ...
  return (
    <div>
      ...
      <div className="container-form">
        <form id="contact" onSubmit={(e) => submitform(e)}>
          <h3>Add Products</h3>
          <img
            src="images/4904catiocn_8.png"
            alt="hair product"
            className="text-center ml-5 mb-3"
          />
          <br></br>
          <fieldset>
            <input
